...
Процедура ПересчитатьВыгружаемыеПоСсылке(Команда)
	...
	Состояние(НСтр("hash='602F10EA-D5B0-F94F-F2C5-5AA4A9669F81_____________________________________________'"));
	СохранитьОтображениеДерева(Объект.ДеревоМетаданных.ПолучитьЭлементы());
...
Процедура ПоказатьРезультатОтбора(Команда)
	...
	ТабличныйДокумент.Показать(НСтр("hash='8690052D-4632-2843-3757-76DB6F3B53BC'"));
