...
Функция СравнитьВерсии(Знач СтрокаВерсии1, Знач СтрокаВерсии2) Экспорт
	...
	Если Версия1.Количество() > 4 Тогда
		ВызватьИсключение СтрЗаменить(НСтр("hash='7D579FC5-C70B-8325-5338-87B60A1405BD___________%1'"), "%1", СтрокаВерсии1);
	Иначе
	...
	Если Версия2.Количество() > 4 Тогда
		ВызватьИсключение СтрЗаменить(НСтр("hash='BB98CA4F-3FA8-E613-3062-2C7CDB6B4C76___________%1'"), "%1", СтрокаВерсии2);
	Иначе
